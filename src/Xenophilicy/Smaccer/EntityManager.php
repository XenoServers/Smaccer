...
use Xenophilicy\Smaccer\entities\{SmaccerBat, SmaccerBlaze, SmaccerCat, SmaccerCaveSpider, SmaccerChicken, SmaccerCod, SmaccerCow, SmaccerCreeper, SmaccerDolphin,
  SmaccerDonkey, SmaccerDrowned, SmaccerElderGuardian, SmaccerEnderCrystal, SmaccerEnderDragon, SmaccerEnderman, SmaccerEndermite, SmaccerEvoker, SmaccerGhast,
  SmaccerGuardian, SmaccerHorse, SmaccerHuman, SmaccerHusk, SmaccerIronGolem, SmaccerLavaSlime, SmaccerLlama, SmaccerMule, SmaccerMushroomCow, SmaccerOcelot,
  SmaccerPanda, SmaccerParrot, SmaccerPhantom, SmaccerPig, SmaccerPigZombie, SmaccerPolarBear, SmaccerPufferfish, SmaccerRabbit, SmaccerSalmon, SmaccerSheep,
  SmaccerShulker, SmaccerSilverfish, SmaccerSkeleton, SmaccerSkeletonHorse, SmaccerSlime, SmaccerSnowman, SmaccerSpider, SmaccerSquid, SmaccerStray, SmaccerTropicalFish,
  SmaccerTurtle, SmaccerVex, SmaccerVillager, SmaccerVindicator, SmaccerWitch, SmaccerWither, SmaccerWitherSkeleton, SmaccerWolf, SmaccerZombie, SmaccerZombieHorse,
...
class EntityManager {
    ...
    const ENTITY_ALIASES = ["Dragon" => "EnderDragon", "EDragon" => "EnderDragon", "MagmaCube" => "LavaSlime", "ZombiePigman" => "PigZombie", "Mooshroom" => "MushroomCow", "Player" => "Human", "VillagerZombie" => "ZombieVillager", "SnowGolem" => "Snowman", "FallingBlock" => "FallingSand", "FakeBlock" => "FallingSand", "VillagerGolem" => "IronGolem", "EGuardian" => "ElderGuardian", "Emite" => "Endermite", "Crystal" => "EnderCrystal"];
